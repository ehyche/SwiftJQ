...
// XXXMEH BEGIN - change from enum to static int const to avoid compiler error
//enum jv_kind_enum {
//  JV_KIND_INVALID = 0,
//  JV_KIND_NULL = 1,
//  JV_KIND_FALSE = 2,
...
//  JV_KIND_OBJECT = 7
//};
static int const JV_KIND_INVALID = 0;
static int const JV_KIND_NULL    = 1;
static int const JV_KIND_FALSE   = 2;
static int const JV_KIND_TRUE    = 3;
static int const JV_KIND_NUMBER  = 4;
static int const JV_KIND_STRING  = 5;
static int const JV_KIND_ARRAY   = 6;
static int const JV_KIND_OBJECT  = 7;
typedef int jv_kind;
// XXXMEH END
...
// XXXMEH - change from "enum jv_kind" to just "jv_kind"
...
//};
static int const JV_PRINT_PRETTY   = 1;
static int const JV_PRINT_ASCII    = 2;
static int const JV_PRINT_COLOUR   = 4;
static int const JV_PRINT_SORTED   = 8;
static int const JV_PRINT_INVALID  = 16;
static int const JV_PRINT_REFCOUNT = 32;
static int const JV_PRINT_TAB      = 64;
static int const JV_PRINT_ISATTY   = 128;
static int const JV_PRINT_SPACE0   = 256;
static int const JV_PRINT_SPACE1   = 512;
static int const JV_PRINT_SPACE2   = 1024;
typedef int jv_print_flags;
// XXXMEH END
